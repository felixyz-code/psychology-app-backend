...
export const CANONICAL_TEMPLATE_VARIABLES: readonly TemplateVariableMetadata[] =
  [
    ...
    },
    {
      ...
      label: 'Sede / Sucursal',
      description:
        'Nombre de la sede donde tendrá lugar la atención presencial',
    ...
    },
    {
      ...
      exampleValue:
        'Av. Las Palmas 340, Consultorio 4B / https://meet.psiqueos.com/session-xyz',
      category: 'appointment',
    },
    {
      key: 'rescheduleLink',
    ...
    },
    {
      ...
      description:
        'Enlace directo y seguro para que el paciente ingrese a la sala virtual',
      exampleValue:
        'https://app.psiqueos.com/teleconsulta/abc123def456ghi7?token=3f8b0561-1c39-4475-8123-ec2d79ba4d78',
      category: 'appointment',
    },
  ];
...
export const DEFAULT_NOTIFICATION_TEMPLATES: readonly DefaultTemplateDefinition[] =
  [
    ...
    // 4. APPOINTMENT_RESCHEDULED
    {
      ...
      subject:
        'Actualización: Tu cita en {{organizationName}} ha sido reprogramada',
